...
async function init() {
  ...
  let players = [
    ...
    { id: '76561198019349637', platform: 'steam'},
    { id: 'arnarfreyrgud', platform: 'epic'},
    { id: '76561198027362804', platform: 'steam'},
    { id: 'jonvaldimar81', platform: 'epic'},
    { id: 'Valtyr_Runar', platform: 'psn'},
    { id: 'alliking1903', platform: 'psn'},
    { id: 'ByssuBaldur', platform: 'psn'},
    { id: 'Hiegkari', platform: 'epic'},
    { id: 'HalldorGauti', platform: 'epic'},
    { id: 'Flopper_0809', platform: 'psn'},	
    { id: 'Danielirvine25', platform: 'psn'},
    { id: 'Cleansman22', platform: 'psn'},
    { id: 'Davidharalds', platform: 'psn'},
    { id: 'Daninn', platform: 'steam'},
    { id: 'Njósna Ugla', platform: 'epic'},
    { id: 'Nökkvi.', platform: 'epic'},
    { id: 'JcB_RL', platform: 'epic'},
    { id: 'Krissi99', platform: 'epic'},
    { id: 'Ausa.', platform: 'epic'},
    { id: '76561198024583791', platform: 'steam'},
    { id: 'KrókurRl', platform: 'epic'},
